...
def assistant_suggestions():
    ...
    # KEEPERS average pts/gm cost minutes
    ...
    # DEFNEDERS average pts/gm cost minutes
    ...
    for player in transfer_suggestions['defense']['players']:
        if float(player['points_per_game']) >= transfer_suggestions['defense']['average_ppg'] and player['minutes'] >= 60:
             transfer_suggestions['defense']['suggested_defenders'].append(player)

    # MIDFIELDERS average pts/gm cost minutes
    ...
    for player in transfer_suggestions['midfield']['players']:
        if float(player['points_per_game']) >= transfer_suggestions['midfield']['average_ppg'] and player['minutes'] >= 60:
             transfer_suggestions['midfield']['suggested_midielders'].append(player)

    # FORWARDS average pts/gm cost minutes
    ...
    for player in transfer_suggestions['forwards']['players']:
        if float(player['points_per_game']) >= transfer_suggestions['forwards']['average_ppg'] and player['minutes'] >= 60:
...
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][0]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][0]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][0]['minutes']))
print("")
print(transfer_suggestions['keeper']['suggested_keepers'][1]['web_name'])
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][1]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][1]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][1]['minutes']))
print("")
print(transfer_suggestions['keeper']['suggested_keepers'][2]['web_name'])
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][2]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][2]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][2]['minutes']))
print("")
print(transfer_suggestions['keeper']['suggested_keepers'][3]['web_name'])
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][3]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][3]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][3]['minutes']))
print("")
print(transfer_suggestions['keeper']['suggested_keepers'][4]['web_name'])
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][4]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][4]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][4]['minutes']))
print("")
print(transfer_suggestions['keeper']['suggested_keepers'][5]['web_name'])
print("pts/gm: " + str(transfer_suggestions['keeper']['suggested_keepers'][5]['points_per_game']))
print("cost: " + str(transfer_suggestions['keeper']['suggested_keepers'][5]['now_cost']))
print("minutes: " + str(transfer_suggestions['keeper']['suggested_keepers'][5]['minutes']))
print('')
...
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][0]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][0]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][0]['minutes']))
print("")
print(transfer_suggestions['defense']['suggested_defenders'][1]['web_name'])
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][1]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][1]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][1]['minutes']))
print("")
print(transfer_suggestions['defense']['suggested_defenders'][2]['web_name'])
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][2]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][2]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][2]['minutes']))
print("")
print(transfer_suggestions['defense']['suggested_defenders'][3]['web_name'])
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][3]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][3]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][3]['minutes']))
print("")
print(transfer_suggestions['defense']['suggested_defenders'][4]['web_name'])
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][4]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][4]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][4]['minutes']))
print("")
print(transfer_suggestions['defense']['suggested_defenders'][5]['web_name'])
print("pts/gm: " + str(transfer_suggestions['defense']['suggested_defenders'][5]['points_per_game']))
print("cost: " + str(transfer_suggestions['defense']['suggested_defenders'][5]['now_cost']))
print("minutes: " + str(transfer_suggestions['defense']['suggested_defenders'][5]['minutes']))
print("")
...
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][0]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][0]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][0]['minutes']))
print("")
print(transfer_suggestions['midfield']['suggested_midielders'][1]['web_name'])
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][1]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][1]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][1]['minutes']))
print("")
print(transfer_suggestions['midfield']['suggested_midielders'][2]['web_name'])
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][2]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][2]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][2]['minutes']))
print("")
print(transfer_suggestions['midfield']['suggested_midielders'][3]['web_name'])
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][3]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][3]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][3]['minutes']))
print("")
print(transfer_suggestions['midfield']['suggested_midielders'][4]['web_name'])
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][4]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][4]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][4]['minutes']))
print("")
print(transfer_suggestions['midfield']['suggested_midielders'][5]['web_name'])
print("pts/gm: " + str(transfer_suggestions['midfield']['suggested_midielders'][5]['points_per_game']))
print("cost: " + str(transfer_suggestions['midfield']['suggested_midielders'][5]['now_cost']))
print("minutes: " + str(transfer_suggestions['midfield']['suggested_midielders'][5]['minutes']))
print("")
...
print("Suggested Forwards")
print(transfer_suggestions['forwards']['suggested_forwards'][0]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][0]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][0]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][0]['minutes']))
print("")
print(transfer_suggestions['forwards']['suggested_forwards'][1]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][1]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][1]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][1]['minutes']))
print('')
print(transfer_suggestions['forwards']['suggested_forwards'][2]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][2]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][2]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][2]['minutes']))
print('')
print(transfer_suggestions['forwards']['suggested_forwards'][3]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][3]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][3]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][3]['minutes']))
print('')
print(transfer_suggestions['forwards']['suggested_forwards'][4]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][4]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][4]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][4]['minutes']))
print('')
print(transfer_suggestions['forwards']['suggested_forwards'][5]['web_name'])
print("pts/gm: " + str(transfer_suggestions['forwards']['suggested_forwards'][5]['points_per_game']))
print("cost: " + str(transfer_suggestions['forwards']['suggested_forwards'][5]['now_cost']))
print("minutes: " + str(transfer_suggestions['forwards']['suggested_forwards'][5]['minutes']))
print('')
