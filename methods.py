...
team = {
    'picks': 'incoming data source: method <get_users_basic_team>',
    'player_data': 'incoming data source: method <get_all_footballers>',
    'personal_data': 'incoming data source: method <get_users_personal_info>',
    'classic_league': 'incoming data source: method <get_classic_league>',
    'team_info': [
        {
            'id': 1,
            'name': 'Arsenal',
...
def create_profile(email, password, team_id):
    get_users_basic_team(email, password, team_id)
    get_all_footballers()
    get_users_personal_info(team_id)
...
create_profile('cunheez3@gmail.com', 'Tottenham7', 307976)
#organize_by_event_points()
#get_users_basic_team('cunheez3@gmail.com', 'Tottenham7', 307976)
print(user_profile['transfers']['made'])
